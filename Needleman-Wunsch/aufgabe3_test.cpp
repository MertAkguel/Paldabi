...
bool test_repeat()
{
   ...
   score:24
       */
    cout << "align.score() = " << align.score() << endl;
    cout << "score = " << score << endl;
    return (s1 == s11 && s2 == s21 && g == g1 && align.score() == score && score != score_mess);
}
...
bool test_uninitialized()
{
    ...
    string seq_2 = "MYMISSISAHIPPIE";
    Alignment align(seq_1, seq_2);
    // calling score() and getAlignment() before compute() is not allowed
